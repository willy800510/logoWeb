    ...
    <!-- 類別搜尋 -->
            <div class="d-block mt-1">
                <div class="list-group flex-row justify-content-around align-items-center overflow-hidden mx-1" id="myList" role="tablist">
                    <a href="search_food.php" class="text-center list-group-item list-group-item-action active" data-toggle="list" role="tab">美食<br class="d-block d-md-none">餐廳</a>
