        ...
        <div class="d-flex justify-content-between align-items-center px-1 py-2">
            ...
            <div class="nav justify-content-end">   
                <a href="bookmark.php" class="nav-link p-3 head_icon">
                    ...
                    <svg class="headIcon" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill= "var( --logoColor_ob_0)"/></svg>
                </a>
                <span class="dropdown bagInfo head_icon">
                    ...
                    <div class="dropdown-menu bagList" aria-labelledby="dropdownMenuLink">
                        <div class="dropdown-item d-flex align-items-center justify-content-around py-3">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px" fill="rgba(0,0,0,.5)"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
                        </div>
                        <div class="dropdown-item d-flex align-items-center justify-content-around py-3">
                            <a href="#" class="logo"></a>
                            <span class="text-muted">Company Name</span>
    ...
    <div class="container-fluid position-fixed d-xl-none flex-column align-items-start py-3 collapse" id="collapseMenu-sm">
        <div class="container-sm px-1">
            ...
            <a href="#" class="d-flex justify-content-between my-3 menulist" data-toggle="collapse" data-target="#userCollapse" aria-expanded="false" aria-controls="userCollapse">
                <svg width="16" height="23" viewBox="0 0 17 23" fill="none" xmlns="http://www.w3.org/2000/svg" class="col-3 icon"><path d="M12.5875 10.8101C13.5147 9.96508 14.1645 8.85967 14.4515 7.639C14.7386 6.41832 14.6495 5.13945 14.196 3.97028C13.7425 2.80111 12.9457 1.79628 11.9103 1.08772C10.8748 0.379168 9.64916 0 8.39416 0C7.13916 0 5.91349 0.379168 4.87806 1.08772C3.84264 1.79628 3.04585 2.80111 2.59232 3.97028C2.13879 5.13945 2.04971 6.41832 2.33677 7.639C2.62384 8.85967 3.27363 9.96508 4.20084 10.8101C1.69086 11.9401 0 14.05 0 16.4677C0 20.0755 3.75746 23 8.39416 23C13.0309 23 16.7883 20.0755 16.7883 16.4677C16.7883 14.05 15.0975 11.9401 12.5875 10.8101Z" fill="#DBDBDB"/></svg>
