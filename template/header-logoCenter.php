...
<header class="container-fluid position-fixed fixed-top">
    ...
    <div class="container-fluid position-fixed d-xl-none flex-column align-items-start py-3 overflow-auto collapse" id="collapseMenu-sm">
        <div class="container-sm px-1">
            ...
            <a href="carts_lists.php" class="d-flex justify-content-between my-3 menulist">
            ...
            <a href="sysInfo.php" class="d-flex justify-content-between my-3 menulist">
            ...
            <a href="helpCenter.php" class="d-flex justify-content-between my-3 menulist">
                <svg width="16" height="23" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="col-3 icon">
                    ...
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.0609 15.4999C10.5211 15.4999 10.8942 15.1268 10.8942 14.6666C10.8942 14.2063 10.5211 13.8333 10.0609 13.8333C9.60064 13.8333 9.22754 14.2063 9.22754 14.6666C9.22754 15.1268 9.60064 15.4999 10.0609 15.4999Z" fill="white"/>
                </svg>
