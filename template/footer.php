<!-- footer -->
    <footer class="footer container-fluid">
        <div class="container-sm d-none d-xl-block">
            <div class="d-flex justify-content-between align-items-start p-1 px-5">
        ...
        <div class="container-sm d-block d-xl-none justify-content-around align-items-center flex-column p-1">
            <a href="index.php" class="logo" style="width: 95px; height: 95px; margin: auto; display:block"></a>
