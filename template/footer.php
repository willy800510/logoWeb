<!-- footer -->
    <footer class="footer container-fluid">
        ...
        <div class="container-sm d-block d-xl-none justify-content-around align-items-center flex-column p-1">
            ...
            <div class="row">
                <h4 class="col-2 px-0 my-auto d-sm-none text-center bg-logoColor-3 rounded py-2">關於<br>品牌</h4>
                ...
                <h4 class="col-2 px-0 my-auto d-sm-none text-center bg-logoColor-3 rounded py-2">聯絡<br>我們</h4>
