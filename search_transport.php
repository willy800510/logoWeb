    ...
    <!-- 類別搜尋 -->
            <div class="d-block mt-1">
                <div class="list-group flex-row justify-content-around align-items-center overflow-hidden mx-1" id="myList" role="tablist">
                    ...
                    <a href="search_living.php" class="text-center list-group-item list-group-item-action" data-toggle="list" role="tab">居家<br class="d-block d-md-none">生活</a>
                    <a href="search_transport.php" class="text-center list-group-item list-group-item-action active" data-toggle="list" role="tab">行車<br class="d-block d-md-none">交通</a>
