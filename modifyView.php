            ...
            <div class="col-12 col-xl-10 px-0 px-xl-3">
                ...
                <form action="" class="bg-white my-1" method="">
                    ...
                    <div class="text-center p-4">
                        <a href="index.php" class="btn btn-outline-pink">首頁</a>
                        <a href="customizeCenter.php" class="btn btn-outline-pink">客製中心</a>
                        <a href="order.php" class="btn btn-outline-pink">我的訂單</a>
                    </div>
                </form>
            </div>
        </div>
