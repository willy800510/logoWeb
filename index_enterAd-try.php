...
<div class="container-fluid mToTop d-md-none">
    ...
    <nav id="enterAd-md" class="navbar position-fixed z-index-2" data-aos="fade-down" data-aos-easing="ease-in-sine">
    ...
    <div data-spy="scroll" data-target="#enterAd-md" data-offset="-20">
        ...
        <div class="row mt-5" id="shopFlow-md">
            ...
            <div class="col-10 d-flex flex-column align-items-end">
                ...
                <span class="material-icons md-36 pink mx-auto" data-aos="flip-down">arrow_downward</span>
                <div class="col-9 d-flex align-items-center justify-content-around mx-3" data-aos="zoom-in-left">
        ...
        <!-- 更多商品 -->
        <section class="row mt-5" id="moreProduct-md" style="height: 1000px;" data-aos="zoom-in-up">
            <div class="lgdp waterfall">
                <a href="product.php">
                    <img src="images/AdobeStock_250566348 [轉換].svg" alt="" width="150px" class="d-block p-3 m-auto rounded">
                </a>
            </div>
            <div class="lgdp waterfall">
                <a href="product.php">
